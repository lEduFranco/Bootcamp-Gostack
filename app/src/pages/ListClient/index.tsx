  ...
  return (
    <Container>
      ...
      <ProvidersList
        ...
        ListHeaderComponent={<ProvidersListTitle>Clientes</ProvidersListTitle>}
      ...
      <ClientButton onPress={() => navigation.navigate('Dashboard')}>
        <Icon name="user" size={20} color="#b28d9f" />
        <ClientButtonText>Diaristas</ClientButtonText>
      </ClientButton>
    </Container>
  );
};
